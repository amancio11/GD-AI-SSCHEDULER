import {
  ...
  usePositioner,
  usePreviousValue
} from "./chunk-Y37II2KA.js";
import {
  getCssDimensions
} from "./chunk-7CJQ7L4V.js";
import {
  DirectionContext,
  useDirection
} from "./chunk-H2FBZGOI.js";
import {
  ...
  useValueAsRef
} from "./chunk-BPP7NJHB.js";
import "./chunk-B5YHL7TY.js";
import {
  inertValue
} from "./chunk-CQ7QMDZ7.js";
import "./chunk-MOO2IH4A.js";
import {
  useTimeout
} from "./chunk-RZ42E2QW.js";
import {
  contains,
...
} from "./chunk-CQZTO6D2.js";
import {
  isElement,
  useIsoLayoutEffect,
  useStableCallback
} from "./chunk-7JSZCYH6.js";
import {
  require_jsx_runtime
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React14.useRef(null);
  const liveDimensionsRef = React14.useRef(null);
  const isInitialRenderRef = React14.useRef(true);
  const restoreAnchoringStylesRef = React14.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React14.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  const capturedNodeRef = React16.useRef(null);
  const [previousContentNode, setPreviousContentNode] = React16.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React16.useState(null);
  const currentContainerRef = React16.useRef(null);
  const previousContainerRef = React16.useRef(null);
  const onAnimationsFinished = useAnimationsFinished(currentContainerRef, true, false);
  const cleanupFrame = useAnimationFrame();
  const [previousContentDimensions, setPreviousContentDimensions] = React16.useState(null);
  const [showStartingStyleAttribute, setShowStartingStyleAttribute] = React16.useState(false);
  useIsoLayoutEffect(() => {
  ...
  const lastHandledTriggerRef = React16.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime7.jsxs)(React16.Fragment, {
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React16.useState(0);
  const previousActiveTriggerIdRef = React16.useRef(activeTriggerId);
  const previousPayloadRef = React16.useRef(payload);
  const pendingPayloadUpdateRef = React16.useRef(false);
  useIsoLayoutEffect(() => {
...
var TooltipViewport = React17.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
