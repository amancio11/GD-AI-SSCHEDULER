...
} from "./chunk-RZFT2APF.js";
import {
  useControlled
} from "./chunk-3IN75AKA.js";
import {
  InternalBackdrop,
  useOpenInteractionType,
  useScrollLock,
  useValueChanged
} from "./chunk-NXHP4VYA.js";
import {
...
import {
  COMPOSITE_KEYS
} from "./chunk-QBKWIV7F.js";
import {
  useButton
} from "./chunk-NUH73BFQ.js";
import {
  inertValue
        ...
        ...validation.getInputValidationProps({
          ...
          onChange(event) {
            ...
            if (event.nativeEvent.defaultPrevented || disabled || readOnly) {
              (_a = event.preventBaseUIHandler) == null ? void 0 : _a.call(event);
              return;
            }
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React12.useState(false);
  useIsoLayoutEffect(() => {
...
var ToolbarRootContext = React14.createContext(void 0);
...
var SelectPopup = React15.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  ...
  useIsoLayoutEffect(() => {
    ...
    try {
      ...
      const isPinchZoomed = (((_b = win.visualViewport) == null ? void 0 : _b.scale) ?? 1) !== 1 && isWebKit;
...
var SelectItem = React18.memo(React18.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  ...
  const allowMouseSelectionRef = React18.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
...
var Separator = React28.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
