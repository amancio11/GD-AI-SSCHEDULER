...
var TabsRoot = React2.forwardRef(function TabsRoot2(componentProps, forwardedRef) {
  ...
  const notifyAutomaticValueChange = useStableCallback((nextValue, reason) => {
    onValueChangeProp == null ? void 0 : onValueChangeProp(nextValue, createChangeEventDetails(reason, void 0, void 0, {
...
var TabsIndicator = React6.forwardRef(function TabsIndicator2(componentProps, forwardedRef) {
  const {
    className,
    render,
...
var TabsPanel = React7.forwardRef(function TabsPanel2(componentProps, forwardedRef) {
  const {
    className,
    value,
    render,
